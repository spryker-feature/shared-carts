...
## Optional modules
- [CartPermissionGroupsRestApi ^1.3.0](https://github.com/spryker/cart-permission-groups-rest-api) (Legacy Glue)
- [SharedCartsRestApi ^1.3.0](https://github.com/spryker/shared-carts-rest-api) (Legacy Glue)
